...
public class DataSourceSwitch {
    ...
    @Before("execution(* com.tima.admin.*.*Service.*(..))")
    public void dataPlatform(JoinPoint joinPoint) {
        setDataSourceKey(joinPoint, GlobalConstant.ADMIN_DATA_SOURCE_KEY);
    }
/*
    @Before( "execution(*  com.tima.sharedcar.rcsModule.*.*Service.*(..))" )
    public void shop ( JoinPoint joinPoint ) {
        setDataSourceKey( joinPoint , GlobalConstant.RCS_DATA_SOURCE_KEY );
    }*/
